...
alias la="ls -Ah ${colorflag} --group-directories-first"
# List all files colorized in long format, excluding . and ..
alias ll="ls -l ${colorflag} --group-directories-first"
alias lla="ls -lAh ${colorflag} --group-directories-first"
